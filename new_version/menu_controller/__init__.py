...
from new_version.bouncing_button import BouncingButton
...
class MenuController:
    ...
    def controls_menu(self):
        ...
        self._to_blit_resizing_text.append(
            ResizingText(controls_text, (100, 100), 570, TEXT_COLOR_COMBO, MEDIUM_BUTTON_FONT))
    
    def bouncing_button_menu(self):
        self._reset_blits()
        self._to_blit_bouncing_buttons.append(BouncingButton('BOUNCE', (640, 800), TEXT_COLOR_COMBO, MEDIUM_BUTTON_FONT))
